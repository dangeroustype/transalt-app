...
this.props.navigation.closeDrawer();
  ...
  onCollectionUpdate = (querySnapshot) => {
    ...
    this.setState({bike_forecast, loading: false});
  ...
  render() {
    ...
    return (<View style={styles.container}>
      <FlatList data={this.state.bike_forecast} renderItem={({item}) => <BikeForecastArticle {...item}/>} onEndReached={this.onEndReached.bind(this)} onEndReachedThreshold={0.5} onMomentumScrollBegin={() => {
          this.onEndReachedCalledDuringMomentum = false;
        }} refreshing={this.state.refreshing} onRefresh={this.handleRefresh}/>
    </View>)
  }
}
