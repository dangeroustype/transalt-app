...
* Maybe refactor using this? (https://www.npmjs.com/package/react-native-render-html)
* Implement navigation
* Style text inside the WebView
* re-add fonts
* images don't load, do a find-and-replace on the string
* if 24 hours have passed since last refresh, refresh automatically

@TODO DONE!

* fix html entities in titles (FIXED by adding title to HTML blob)
* Currently loading new posts is broken.
* Posts also don't have the right height when they load in the WebView. FIXED!
  */}
